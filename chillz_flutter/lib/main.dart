...
class _ChillzHomeState extends State<ChillzHome> with WidgetsBindingObserver {
  ...
  // Dev mode
  bool _devMode =
      true; // DEBUG: enable automated attach/play for validation in debug builds
      ...
      content = const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              'VLC handles everything - no ghost audio!',
        ...
        appBar: AppBar(
          title: Row(
            children: [
              ...
              const SizedBox(width: 8),
              const Text('Chillz — Direct libVLC'),
            ],
          ),
