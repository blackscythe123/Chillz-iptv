...
```
c:\Users\sam\OneDrive\one drive back up\OneDrive - SSN-Institute\Documents\projects\Chillz-in-browser\Chillz_desktop\
```

### Temp Build Location (Required for Windows)
```
C:\Temp\Chillz_desktop\
```
...
New-Item -ItemType Directory -Force -Path "C:\Temp\Chillz_desktop"

# Copy entire project (excluding build folder)
robocopy "c:\Users\sam\OneDrive\one drive back up\OneDrive - SSN-Institute\Documents\projects\Chillz-in-browser\Chillz_desktop" "C:\Temp\Chillz_desktop" /E /XD build .dart_tool
```

### Step 2: Update Main Dart File
```powershell
# Copy updated main.dart
Copy-Item -Force "c:\Users\sam\OneDrive\one drive back up\OneDrive - SSN-Institute\Documents\projects\Chillz-in-browser\Chillz_desktop\lib\main.dart" "C:\Temp\Chillz_desktop\lib\main.dart"
```

### Step 3: Build and Run
```powershell
# Navigate to temp folder
Push-Location "C:\Temp\Chillz_desktop"
...
**Solution**: Always build from `C:\Temp\Chillz_desktop\`
